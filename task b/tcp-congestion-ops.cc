...
void TcpCongestionOps::IncreaseWindowSantaCruz (Ptr<TcpSocketState> tcb, uint32_t curr_qued_pkts, uint32_t op_point){}
void TcpCongestionOps::DecreaseWindowSantaCruz (Ptr<TcpSocketState> tcb, uint32_t curr_qued_pkts, uint32_t op_point){}
...
TcpNewReno::TcpNewReno (void) : TcpCongestionOps ()
{
  ...
  //NS_LOG_UNCOND ("New Reno Constructor");
}
 ...
 * > each ACK received tattention texthat cumulatively acknowledges new data.  Slow
...
TcpNewReno::SlowStart (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  ...
  //NS_LOG_UNCOND ("New Reno Slow start");
...
TcpNewReno::CongestionAvoidance (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  ...
  //NS_LOG_UNCOND ("New Reno Congestion Avoidance");
...
TcpNewReno::IncreaseWindow (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  ...
  //NS_LOG_UNCOND ("New Reno Window Increase");
