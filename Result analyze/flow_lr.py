...
for flow in et.findall("FlowStats/Flow"):
	...
	total_sent_bits += int(flow.get('txBytes'))
...
print("Network Throughput = " + str(total_received_bits*8/ (duration)) +" bps")
print("Mean delay = " + str(delaySum * 1e-6 / totalrxPackets) + " ms")
print("Packet delivery ratio = " + str(totalrxPackets * 100 / (totaltxPackets)))
print("Packet drop ratio = " + str(totallostPackets * 100 / (totaltxPackets)))
