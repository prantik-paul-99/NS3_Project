...
print("Network Throughput = " + str(total_received_bits*8/ (duration*1e6*(flows/2))) +" Mbps")
print("Mean delay = " + str(delaySum * 1e-6 / totalrxPackets) + " ms")
print("Packet delivery ratio = " + str(totalrxPackets * 100 / (totallostPackets + totalrxPackets)))
print("Packet drop ratio = " + str(totallostPackets * 100 / (totallostPackets + totalrxPackets)))
